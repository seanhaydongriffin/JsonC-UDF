...
ConsoleWrite(@CRLF & "Iterating over the JSON array as a standalone object: " & @CRLF)
...
ConsoleWrite(@CRLF & "Iterating over the JSON array as a object from the complete JSON: " & @CRLF)
